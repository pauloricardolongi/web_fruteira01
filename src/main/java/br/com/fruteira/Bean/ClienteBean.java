...
import br.com.fruteira.dao.CidadeDAO;
import br.com.fruteira.dao.ClienteDAO;
import br.com.fruteira.dao.EstadoDAO;
...
public class ClienteBean implements Serializable {
	...
	public void excluir(ActionEvent evento) {
		try {
			...
			Messages.addGlobalInfo("Cliente removida com sucesso");
		} catch (RuntimeException erro) {
			Messages.addFlashGlobalError("Ocorreu um erro ao tentar remover a cliente");
			erro.printStackTrace();
		}
	}
	...
	public void editar(ActionEvent evento){
		try {
			cliente = (Cliente) evento.getComponent().getAttributes().get("cidadeSelecionada");
